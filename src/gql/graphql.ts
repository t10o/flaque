...
export type PostQuery = { __typename?: 'Query', post?: { __typename?: 'Post', id: string, title: string, tags: Array<string>, date: any, emoji: string, content: { __typename?: 'RichText', markdown: string } } | null };
